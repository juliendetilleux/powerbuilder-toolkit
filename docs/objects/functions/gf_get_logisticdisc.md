...
- **Signature**: `integer gf_get_logisticdisc(string as_cust, string as_item, datetime adt_datreq, ref s_saleprice astr_saleprice, decimal adec_qty)`
- **Description**: Retourne la remise logistique
