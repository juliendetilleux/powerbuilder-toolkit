...
```sql
  SELECT items.itname,   
         ...
         salline.slshipto, 
			...
			locations.lcexp,
			salline.slqtyreq,
			(SELECT adresses.adinvm
				FROM adresses
				WHERE adresses.adcode = salhead.shcust) as adinvm,
			(Select first count(*) 
		...
		truckline.tlsort,	/*os2513*/
		truckline.tlcode, /*os2532*/
		truckline.tlline	/*os2532*/,
