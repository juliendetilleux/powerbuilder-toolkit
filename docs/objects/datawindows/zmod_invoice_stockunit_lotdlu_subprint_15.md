# zmod_invoice_stockunit_lotdlu_subprint_15
         ...
         Invoicehead.ihcurr AS ihcurr,
			...
			(Select lkadref
				...
				Where yv_linkitad.lkactiv = 'Y'
					...
					And yv_linkitad.lkadcode = sale_cust) AS lkadref,
			(Select lkadref2
				From yv_linkitad
				Where yv_linkitad.lkactiv = 'Y'
					And yv_linkitad.lktyp = 'S'
					And yv_linkitad.lkitem = Invoiceline.ilitem
					And yv_linkitad.lkadcode = sale_cust) AS lkadref2,
