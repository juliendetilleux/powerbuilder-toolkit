...
- **Ancetre**: w_main
- **Module**: _sales_crm
- **Description**: Courrier/email inbox (CRM)
...
| olFormatHTML | Integer (constant) |
| olFormatPlain | Integer (constant) |
| olFormatRichText | Integer (constant) |
| olFormatUnspecified | Integer (constant) |
...
| wf_open_outlookxprs() | public | Ouverture |
| get_mails_outlookxprs() | public | Calcule/retourne get_mails_outlookxprs |
| wf_show_mail_msoutlook(long row) | public | Affichage |
| wf_show_mail_mapi(long row) | public | Affichage |
| wf_show_mail(long row) | public | Affichage |
| wf_drop_mail_mapi(long row) | public | Traitement wf_drop_mail_mapi |
| wf_save_eml_mapi(long al_row, string as_adcode) | public | Sauvegarde les donnees |
| wf_delete_mail() | public | Suppression |
| wf_drop_mail_msoutlook(long row, boolean candelete, integer fileref, integer fileline) | public | Calcule/retourne wf_drop_mail_msoutlook |
