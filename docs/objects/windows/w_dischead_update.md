...
- **Ancetre**: w_response
- **Module**: _masters
- **Description**: Dischead - Mise a jour (Donnees de base)
...
| wf_creation_fichier_dischead() | public | Traitement wf_creation_fichier_dischead |
| wf_creation_fichier_linkaddiscount(integer ai_row) | public | Ajout |
