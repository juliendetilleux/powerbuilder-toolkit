# Procedure: SP_marge_period_item
...
## Source
```sql
create PROCEDURE DBA.SP_marge_period_item( IN @Sel_period char (6) , in @Sel_period2 char (6) )
	RESULT( item_code varchar(12), item_name char(30),  invoiced_qty_p1 numeric (25,7), invoiced_value_p1 numeric (25,7), purchase_value_p1 numeric (25,7), p2invoiced_qty numeric (25,7), p2invoiced_value numeric (25,7) , p2purchase_value numeric (25,7))
	BEGIN
		declare @pkid numeric(9,0); --001
		  ...
		  declare @item_group_id char(2); --025
		  ...
		  declare @cust_uf08 varchar(20); --057
		  declare @cust_uf09 varchar(20); --058
		  declare @cust_u
```

*Source tronquee (12329 caracteres au total)*
